...
#define GPIO_MOTOR_RIGHT_EN 11  // Must be a PWM pin
#define GPIO_MOTOR_RIGHT_IN1 9
#define GPIO_MOTOR_RIGHT_IN2 10
...
#define GPIO_MOTOR_LEFT_EN 6  // Must be a PWM pin
#define GPIO_MOTOR_LEFT_IN1 8
#define GPIO_MOTOR_LEFT_IN2 7
